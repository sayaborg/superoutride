...
| [Footprints](../src/groundmap/terrain-footprint-analysis.ts) and [target envelope](../src/groundmap/ground-map-target-envelope.ts): footprint, level capacity, observed footprint                                                                        | m                                                   | Source-footprint accumulation, compiled capacity and observed-bound checks are separate comparisons.                                  |

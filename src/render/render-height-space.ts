 ...
 */
export function mapPhysicalHeightToRender(height: HeightProfileReader, s: number, physicalY: number): number {
...
export function createRenderSpaceCamera(height: HeightProfileReader, camera: PseudoCamera): PseudoCamera {
  return {
    ...camera,

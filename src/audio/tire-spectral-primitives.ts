...
/** Shared material following, independent of a generator's audible components. */
...
/** The same observation boundary for all consumers of spectral components. */
export function validateSpectralObservation(value: SpectralObservation, surfaceIndex: number): void {

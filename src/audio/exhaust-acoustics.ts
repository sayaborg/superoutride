...
// Listening-output conditioning: DC removal, bandwidth and bounded amplitude; not exhaust properties.
export const OUTPUT = Object.freeze({ dcHz: 18, cutoffHz: 7300, ceiling: 0.65 });

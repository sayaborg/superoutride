...
- `diagnostics/` owns input recording and vehicle telemetry. Engine and front/rear tire synthesis belong to [audio](../../docs/audio.md); sound audition tools live in `tools/`.

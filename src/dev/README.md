...
- `diagnostics/` owns input recording, vehicle telemetry and the deferred wind/noise sound prototypes. Their test consumers keep the prototypes verifiable; production audio does not import or register them. Front/rear tire synthesis now belongs to production audio. See [audio](../../docs/audio.md).

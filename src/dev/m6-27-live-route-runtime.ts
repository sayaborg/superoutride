...
import { createM637SymmetricSecondLiveForkRuntime } from './m6-37-symmetric-right-second-live-fork.js';
 ...
 * M6.37 gives both LEFT and RIGHT paths a second visible physical fork while preserving the same
 * generic gate -> PENDING -> seam COMMIT browser transaction.
 */
export function createM627LiveRouteRuntime(
  ...
  return createM637SymmetricSecondLiveForkRuntime(parentGuide, parentContent, spriteAssets);
}

...
export function createStadiumSurfaceRegionAuthoring(courseLength: number): SurfaceRegionAuthoring[] {
  ...
  return starts.map((entry) => {
    ...
    return {
      ...
      groundBaseLeft: cliff
        ...
        : { kind: 'color' as const, color: STADIUM_SURFACE_BASE_COLORS.grass },
      groundBaseRight: {
        kind: 'color' as const,
        color: cliff ? STADIUM_SURFACE_BASE_COLORS.rock : STADIUM_SURFACE_BASE_COLORS.grass,
      },

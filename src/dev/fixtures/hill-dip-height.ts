...
/** Historical DEV elevation fixture. Product height authority remains HeightProfile authoring. */
export function createHillDipHeightProfile(courseLength: number): HeightProfile {
  const interior = [
    { s: 0, y: 0 },
    { s: 60, y: 0 },
    { s: 125, y: 8 },

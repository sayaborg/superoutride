...
function entry(value: VehicleCatalogEntry): Readonly<VehicleCatalogEntry> {
  ...
  if ((value.keyCode === undefined) !== (value.keyLabel === undefined)
    || (value.keyCode !== undefined && (typeof value.keyCode !== 'string' || !value.keyCode.trim()
...
export function compileVehicleCatalog(values: readonly VehicleCatalogEntry[]): readonly Readonly<VehicleCatalogEntry>[] {
...
export const VEHICLE_CATALOG: readonly Readonly<VehicleCatalogEntry>[] = compileVehicleCatalog([
  { manufacturer: 'Ferrari', model: 'Testarossa',
    ...
    presentationFamily: 'CAR', profile: FERRARI_TESTAROSSA_VEHICLE_PROFILE, torqueProtection: ROAD_TORQUE_POLICY,
    keyCode: 'KeyQ', keyLabel: 'Q', mobileLabel: 'F110' },
  { manufacturer: 'Porsche', model: '911 Turbo 3.3',
    identifier: { officialLabel: 'Type 930', shortLabel: '930' },
    selectedSpecification: ['G50/50 5-speed'], period: '1989',
    physicsAnchor: { modelYear: '1989', market: 'European/ROW' },
    presentationFamily: 'CAR', profile: PORSCHE_911_TURBO_3_3_VEHICLE_PROFILE, torqueProtection: ROAD_TORQUE_POLICY,
  ...
  { manufacturer: 'Chevrolet', model: 'Corvette',
    ...
    presentationFamily: 'CAR', profile: CHEVROLET_CORVETTE_C4_VEHICLE_PROFILE, torqueProtection: ROAD_TORQUE_POLICY,
    keyCode: 'KeyE', keyLabel: 'E', mobileLabel: 'C4' },
  { manufacturer: 'Volkswagen', model: 'Golf GTI 16V',
    ...
    presentationFamily: 'CAR', profile: VOLKSWAGEN_GOLF_GTI_16V_VEHICLE_PROFILE, torqueProtection: ROAD_TORQUE_POLICY,
    keyCode: 'KeyR', keyLabel: 'R', mobileLabel: 'GTI' },
  { manufacturer: 'Lancia', model: 'Delta HF Integrale', identifier: null,
    selectedSpecification: ['8V', '185 PS'], period: '1988–1989',
    physicsAnchor: { modelYear: '1988', market: 'European/ROW' },
    presentationFamily: 'CAR', profile: LANCIA_DELTA_HF_INTEGRALE_VEHICLE_PROFILE, torqueProtection: ROAD_TORQUE_POLICY,
    keyCode: 'KeyA', keyLabel: 'A', mobileLabel: 'DELTA' },
  { manufacturer: 'Honda', model: 'VFR750R',
    ...
    presentationFamily: 'BIKE', profile: HONDA_VFR750R_VEHICLE_PROFILE, torqueProtection: TWO_WHEEL_TORQUE_POLICY,
    keyCode: 'KeyS', keyLabel: 'S', mobileLabel: 'RC30' },
  { manufacturer: 'BMW', model: 'R 80 G/S Paris-Dakar', identifier: null,
    selectedSpecification: [], period: '1984–1987',
    physicsAnchor: { modelYear: '1985', market: 'European/ROW' },
    presentationFamily: 'BIKE', profile: BMW_R80_GS_PARIS_DAKAR_VEHICLE_PROFILE, torqueProtection: TWO_WHEEL_TORQUE_POLICY,
    keyCode: 'KeyD', keyLabel: 'D', mobileLabel: 'R80' },
  { manufacturer: 'Harley-Davidson', model: 'FXRT Sport Glide',
    ...
    presentationFamily: 'BIKE', profile: HARLEY_DAVIDSON_FXRT_VEHICLE_PROFILE, torqueProtection: TWO_WHEEL_TORQUE_POLICY,
    keyCode: 'KeyF', keyLabel: 'F', mobileLabel: 'FXRT' },
  { manufacturer: 'Vespa', model: 'PX 200 E Arcobaleno',
    ...
    presentationFamily: 'BIKE', profile: VESPA_PX200E_ARCOBALENO_VEHICLE_PROFILE, torqueProtection: TWO_WHEEL_TORQUE_POLICY,

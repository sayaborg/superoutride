...
export const VEHICLE_SOUND_PROFILES = Object.freeze({
  TESTAROSSA: compileVehicleAudioProfile({
    ...
    pulse: { strength: 1.0, riseSeconds: 0.00018, decaySeconds: 0.006 },
  }),
  '911_TURBO_3_3': compileVehicleAudioProfile({
    ...
    cycleRevolutions: 2,
    firingPhases: even(6),
    pulse: { strength: 0.9375, riseSeconds: 0.00018, decaySeconds: 0.006 },
  }),
  CORVETTE_C4: compileVehicleAudioProfile({
    ...
    cycleRevolutions: 2,
    firingPhases: even(8),
    pulse: { strength: 1.0625, riseSeconds: 0.00018, decaySeconds: 0.006 },
  }),
  GOLF_GTI_16V: compileVehicleAudioProfile({
    exhaust: { banks: [0, 0, 0, 0], lengths: [0.55, 0.42, 0.48, 0.6], outlet: 1.25 },
    cycleRevolutions: 2,
    firingPhases: even(4),
    pulse: { strength: 0.875, riseSeconds: 0.00018, decaySeconds: 0.006 },
  }),
  ...
  PX200E_ARCOBALENO: compileVehicleAudioProfile({
    ...
    cycleRevolutions: 1,
    firingPhases: [0],
    pulse: { strength: 0.8125, riseSeconds: 0.00018, decaySeconds: 0.006 },
  }),
});

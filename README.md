...
Open DEV for vehicle, camera, calibration and sound controls. Key 1 selects LINEAR; key 2 selects its two-Section SEAM version; key 3 selects the two-lap CIRCUIT with two rivals. D, M and ACT use minus/value/plus controls; steps wrap at their limits. Physics and audio tuning remain deferred (DEV_UNCALIBRATED).

...
const bump = sign => compileGuidePath(compileRasterPath([
  { x: 0, z: 0 }, { x: 0, z: 100 }, { x: sign, z: 120 },
  { x: sign, z: 140 }, { x: 0, z: 160 }, { x: 0, z: 1000 },
]), { lMax: 1, mMin: 0.25 });
const sourceFrame = bump(1);
const link = targetFrame => ({ id: 'overlap', sourceFrame, targetFrame,
  sourceSeamS: sourceFrame.length / 2, targetSeamS: targetFrame.length / 2,
  sourceLocalL: 0, targetLocalL: 0, overlapBehind: sourceFrame.length / 2,

...
test('M6.20 route topology remains live while browser runtime advances through M6.23 packages', async () => {
  ...
  assert.match(source, /createM623LiveStageRuntimeRegistry/);

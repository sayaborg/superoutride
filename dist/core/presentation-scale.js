...
export function cameraDistanceForFocalLength(focalLengthPixels) {
...
export function pixelsPerMeterAtDepth(focalLengthPixels, depthMeters) {
...
export function screenWidthForWorldWidth(worldWidthMeters, focalLengthPixels, depthMeters) {

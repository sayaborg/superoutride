...
export function resetM5CameraRig(rig) {
    rig.yaw = 0;
    rig.lateral = 0;
...
export function updateM5Camera(rig, guide, height, vehicle, profile, dt) {
...
function projectedPlayerX(playerX, playerZ, cameraX, cameraZ, cameraYaw, centerX, scale) {

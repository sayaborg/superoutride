...
export const REFLECTION_CANDIDATES = [
  ...
  {
    label: 'A：反射を弱く',
    description: '出口反射 −1 → −0.35。反射による響きを抑えます。',
    tuning: { outletReflection: -0.35 },
  },
  {
    label: 'B：反射を少し弱く',
    description: '出口反射 −1 → −0.90。完全反射より少し損失を増やします。',
    tuning: { outletReflection: -0.9 },
  },
  {
    label: 'C：高域を減衰',
    description: '境界フィルター 3,100 → 1,800 Hz。反射波と出口の音色を変えます。',
    tuning: { returnCutoffHz: 1800 },
  },
  {
    label: 'D：管内の損失を増加',
    description: '距離あたりの減衰 0.03 → 0.16 Np/m。長い経路ほど減衰します。',
